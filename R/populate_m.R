...
#'
#' # m1 is [cycle, pre-tunnel state, destination]
#' dim(m$m1)
#'
#' # and m1_dest says which columns of M those destinations are
#' m$m1_dest
#'
#' # every tunnel row of m2 sums to 1 (row 1 is the empty pre-tunnel row)
#' Matrix::rowSums(m$m2)[-1]
