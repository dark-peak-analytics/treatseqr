test_that("consolidate_heseqmat_trace returns correct structure", {
  ...
  full_trace <- extrapolate_heseqmat(m, m_spec)
  
  # Define state names
  state_names <- c("state1", "state2", "state3", "dead")
  
  # Run consolidation
  result <- consolidate_heseqmat_trace(full_trace, m_spec, state_names)
...
test_that("consolidate_heseqmat_trace has correct dimensions", {
...
test_that("consolidate_heseqmat_trace column names are correct", {
...
test_that("consolidate_heseqmat_trace t matrix rows sum to 1", {
...
test_that("consolidate_heseqmat_trace d matrix excludes time 0", {
  m_spec <- specify_m(n_cycles = 5, n_tunnels = 2, pre_tunnel_states = 1)
...
test_that("consolidate_heseqmat_trace handles different numbers of tunnels", {
...
test_that("consolidate_heseqmat_trace dead state accumulates over time", {
...
test_that("consolidate_heseqmat_trace d matrix dead column is survival", {
...
test_that("consolidate_heseqmat_trace initial state starts at 1", {
